<script lang="ts">
    ...
    let hasTextContent = galleryData.galleryConfig.title || galleryData.galleryConfig.date || galleryData.galleryConfig.location;
    let hasLogo = galleryData.galleryConfig.logo?.url
